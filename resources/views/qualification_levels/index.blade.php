...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Qualification Levels</h4>
            </div>
        ...
        @if(count($qualificationLevels) == 0)
            <div class="panel-body text-center">
                <h4>No Qualification Levels Available.</h4>
            </div>
        @else
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    @foreach($qualificationLevels as $qualificationLevel)
                        <tr>
                            <td>{{ $qualificationLevel->qualification_level }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('qualification_levels.qualification_level.show', $qualificationLevel->id ) }}" class="btn btn-info" title="Show Qualification Level">
