            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    @foreach($gradingScales as $gradingScale)
                        <tr>
                            <td>{{ optional($gradingScale->academicYear)->academic_year }}</td>
                            <td>{{ optional($gradingScale->examType)->exam_type_code }}</td>
                            <td>{{ $gradingScale->symbol }}</td>
                            <td>{{ $gradingScale->minimum_mark }}</td>
                            <td>{{ $gradingScale->maximum_mark }}</td>
                            <td>{{ $gradingScale->academic_result }}</td>
                            <td>{{ $gradingScale->result_description }}</td>
